...
<header>
    ...
    <div class="nav-container">
        ...
        <nav>
            <ul id="mainNav">
                <li><a href="../item/index.php" class="<?php echo $current_page == 'index.php' ? 'active' : ''; ?>">
                    <i class="fa-solid fa-house"></i> Dashboard
                </a></li>
                <li><a href="../admin/users.php" class="<?php echo $current_page == 'users.php' ? 'active' : ''; ?>">
                    <i class="fa-solid fa-users"></i> Users
                </a></li>
                <li><a href="../admin/admins.php" class="<?php echo $current_page == 'admins.php' ? 'active' : ''; ?>">
                    <i class="fa-solid fa-user-shield"></i> Admins
                </a></li>
                <li><a href="../admin/household.php" class="<?php echo $current_page == 'household.php' ? 'active' : ''; ?>">
                    <i class="fa-solid fa-home"></i> Household
                </a></li>
