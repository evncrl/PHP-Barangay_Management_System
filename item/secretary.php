<?php
include_once '../includes/secretaryHeader.php';
...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'secretary') {
    echo "<p style='color: red; text-align: center; font-size: 18px;'>You must be logged in as staff to access this page. <a href='/saad/user/login.php'>Log in here</a>.</p>";
    exit();
}
